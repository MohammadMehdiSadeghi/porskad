...
export default function EmbedForm() {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center bg-transparent"><CloseButton /><Spinner label="فرم داره لود می‌شه..." /></div>;
  if (error) return <div className="min-h-screen flex items-center justify-center p-4 bg-transparent"><CloseButton />      <div className="relative max-w-sm w-full">
