...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-[#0B0F17] text-slate-800 dark:text-[#F8FAFC] selection:bg-[#59BBAF] selection:text-[#202A5A] overflow-x-hidden transition-colors duration-200">
      <SEO
