...
// یک لایه‌ی پس‌زمینه‌ی توپر با آفست ۳ تا ۵ پیکسل بالا-چپ (درست مثل
// سایه‌ی استیکر کولاژ) + لایه‌ی اصلی با بوردر ۲ تا ۳ پیکسلی.
// گوشه‌ها نامتقارن (بالا-چپ و پایین-راست گرد) با [corner-shape:squircle].
