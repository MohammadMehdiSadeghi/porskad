...
export default function EmptyState({ icon, title = "این‌جا خالیه!", subtitle = "", action = null, rotate = "", titleClassName = "" }) {
  const IconRender = icon || <FolderOpen size={44} className="text-sec/30 dark:text-gray-400" />;
  return (
