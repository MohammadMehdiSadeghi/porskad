...
const COLORS = {
  teal: "border-teal-text text-teal-text bg-ecosystem-light dark:border-teal-500/40 dark:text-teal-300 dark:bg-teal-950/60",
  ...
  ecosystem: "border-ecosystem-normal text-ecosystem-dark bg-ecosystem-light dark:border-teal-500/40 dark:text-teal-300 dark:bg-teal-950/60",
  ...
  club: "border-club-normal text-club-dark bg-club-light dark:border-purple-500/40 dark:text-purple-300 dark:bg-purple-950/60",
  purple: "border-purple-600 text-purple-700 bg-purple-50 dark:border-purple-500/40 dark:text-purple-300 dark:bg-purple-950/60",
};
