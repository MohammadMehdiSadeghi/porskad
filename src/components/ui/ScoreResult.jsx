...
export default function ScoreResult({ score, total, details, questions }) {
  ...
  if (pct < 50) { color = "female"; emoji = "😢"; message = "نمره پایینه؛ دوباره تلاش کن!"; }
  else if (pct < 75) { color = "college"; emoji = "💪"; message = "خوبه ولی جای بهبود داره!"; }

  const colorMap = {
    ecosystem: { bg: "bg-ecosystem-light", border: "border-ecosystem-normal", text: "text-ecosystem-dark", bar: "bg-ecosystem-normal", backBg: "bg-ecosystem-dark" },
    college: { bg: "bg-college-light", border: "border-college-normal", text: "text-college-dark", bar: "bg-college-normal", backBg: "bg-college-dark" },
    female: { bg: "bg-female-light", border: "border-female-normal", text: "text-female-dark", bar: "bg-female-normal", backBg: "bg-female-dark" },
  };
