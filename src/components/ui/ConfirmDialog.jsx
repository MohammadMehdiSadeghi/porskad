          ...
          >
            ...
            <div className="relative z-10 bg-white border-2 border-male-normal rounded-tl-[1.25rem] rounded-br-[1.25rem] rounded-tr-none rounded-bl-none [corner-shape:squircle] p-4 sm:p-6">
              <div className="text-center mb-3 sm:mb-4">
                ...
                <p className="text-[0.65rem] sm:text-xs font-semibold text-ink-subtle leading-5">
                  {allFilled
              ...
              {unfilledFields.length > 0 && (
                <div className="bg-female-light border border-female-normal/40 rounded-lg p-3 mb-3 sm:mb-4">
                  <span className="text-[0.6rem] sm:text-[0.65rem] font-extrabold text-female-normal mb-1.5 block">
                    فیلدهای اجباری خالی:
                  </span>
                  <ul className="flex flex-col gap-1">
                    {unfilledFields.map((f, i) => (
                      <li key={f.id || i} className="flex items-center gap-1.5 text-[0.65rem] sm:text-xs text-ink">
                        <span className="w-4 h-4 shrink-0 flex items-center justify-center rounded-full bg-female-normal/15 text-female-normal text-[0.5rem] font-black">
                          {faNum(i + 1)}
                        </span>
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <div className="relative flex-1">
                  ...
                  <button onClick={onCancel} className="relative z-10 w-full bg-white border-2 border-ink text-ink font-extrabold py-2 sm:py-2.5 rounded-pill-md [corner-shape:squircle] hover:bg-bg-neutral transition-colors duration-200 text-xs sm:text-sm">
                    بازگشت و ویرایش
                  </button>
                </div>
                <div className="relative flex-1">
                  ...
                  <button onClick={onConfirm} className="relative z-10 w-full bg-ecosystem-normal border-2 border-ecosystem-dark text-white font-extrabold py-2 sm:py-2.5 rounded-pill-md [corner-shape:squircle] hover:bg-ecosystem-dark transition-colors duration-200 text-xs sm:text-sm">
