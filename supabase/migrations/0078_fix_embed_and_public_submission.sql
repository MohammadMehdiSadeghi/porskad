-- ══════════════════════════════════════════════════════════════
-- 0078: Fix get_public_form and submit_public_response for embed & iframes
-- 1. In get_public_form: remove invalid q.deleted_at and q.score (use points)
-- 2. In submit_public_response: remove invalid deleted_at on questions
-- ══════════════════════════════════════════════════════════════
