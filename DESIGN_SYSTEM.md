...
**وزن عناوین:** 800-950  
**حداقل اندازه‌ی فونت:** ۱۳px (تمام متون بدنه و متادیتاها حداقل ۱۳ پیکسل هستند)
...
5. **انیمیشن یکپارچه دکمه‌ها:** تمام دکمه‌ها در هاور `scale-[1.02]` و در کلیک `scale-[0.97]` با ترنزیشن ۲۰۰ms و پس‌زمینه ۱۰۰٪ سالید دارند.
